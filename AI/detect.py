...
detector = cv2.dnn.readNetFromCaffe(
    prototxt_path, caffemodel_path)  # load model
...
def return_box(image):
    ...
    # check confidence of 200 predictions
    list_box = []
    ...
    return list_box  # return list of predictions
...
if __name__ == '__main__':
    show_image_after_detect("test11.jpg")
